 ...
 *
 * @since 1.0.0
 * @Listener(event=SitemapPusherEvent::GENERATE_EXCEPTION)
 */
class GenerateException implements EventHandlerInterface
{
    ...
    public function handle(EventInterface $event): void
    {
        ...
        CLog::error('%s. (At %s line %d)', $exception->getMessage(), $exception->getFile(), $exception->getLine());
    }
}
